...
def make_flights():
    ...
    flight = Flight("BA747", AirBusA319("G-EUPT"))
    ...
    boeingFlight = Flight("AF72", Boeing777("F-GSPS"))
    boeingFlight.allocate_seat("12A", "Senthil Kumar")
    boeingFlight.allocate_seat("15F", "Arun Madhavan")
    boeingFlight.allocate_seat("15E", "Veeraraghavan Rajagopal")
    boeingFlight.allocate_seat("1C", "Priya Natarajan")
    boeingFlight.allocate_seat("1D", "Varun Karthik")
    return flight, boeingFlight
